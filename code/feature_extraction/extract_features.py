...
from code.feature_extraction.tfidf import TfIdf
from code.util import COLUMN_TWEET, COLUMN_LABEL, COLUMN_MONTH, COLUMN_PHOTOS, COLUMN_MENTIONS, COLUMN_URL, COLUMN_RETWEETS, COLUMN_REPLIES, COLUMN_HASHTAG, COLUMN_LIKES, COLUMN_TIME, COLUMN_PROCESSED
...
parser.add_argument("-t", "--tfidf", action = "store_true", help = "extracts tf-idf scores from Tweet")
...
if args.import_file is not None:
    ...
    if args.tfidf:
        # tf-idf
        features.append(TfIdf(COLUMN_PROCESSED))
