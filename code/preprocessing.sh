...
python -m code.preprocessing.run_preprocessing data/preprocessing/labeled.csv data/preprocessing/preprocessed.csv -s --stopwords_input "tweet" -e data/preprocessing/pipeline.pickle
